...
# ============================================================
# 城市ID映射（统一来自 city_resolver，支持内置 120+ 城市 + 动态解析全国市县）
# ============================================================
from packages.utils.city_resolver import CITY_ID_MAP, resolve_city_id_sync
...
def get_destination_weather(city: str, days: int = 7) -> List[Dict]:
    ...
    # 城市解析：内置映射表 → 和风城市搜索API动态解析（全国市县），解除原 24 城限制
    city_id = resolve_city_id_sync(city, weather_api_key)
