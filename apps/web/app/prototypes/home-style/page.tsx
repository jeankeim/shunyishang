...
// 风格原型 harness —— 三个首页风格方向，通过底部选择器切换。
// 行为契约见 prototype skill PICKER.md：1-N / ←→ 切换，R 重放，?v=N 持久化。
import { Suspense, useCallback, useEffect, useLayoutEffect, useRef, useState } from 'react'
import { useSearchParams } from 'next/navigation'
import './picker.css'
import { XuanguangVariant } from './variants/Xuanguang'
import { SongyunVariant } from './variants/Songyun'
import { LiuliVariant } from './variants/Liuli'

const VARIANTS = [
  { name: '玄光', Component: XuanguangVariant },
  { name: '宋韵', Component: SongyunVariant },
  { name: '琉璃', Component: LiuliVariant },
]
