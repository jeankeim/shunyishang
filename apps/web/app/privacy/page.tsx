    ...
    <div className="min-h-screen bg-[var(--brand-surface,#faf9f6)]">
      <div className="max-w-3xl mx-auto px-5 py-10">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-[var(--brand-body,#4a463f)]">
          <section>
            <p>
              我的个人衣橱（以下简称"我们"或"本产品"）深知个人信息对您的重要性，我们依据《中华人民共和国个人信息保护法》（PIPL）、《中华人民共和国网络安全法》等法律法规制定本政策，并恪守以下原则：权责一致、目的明确、选择同意、最小必要、确保安全、主体参与、公开透明。请您在注册和使用本产品前仔细阅读本政策。
            </p>
          </section>
