    ...
    return (
      <header className="h-[60px] border-b border-[var(--brand-border)]/50 flex items-center justify-between px-4 bg-white/90 backdrop-blur-xl">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-semibold text-[var(--brand-heading)] bg-gradient-to-r from-[#3DA35D] to-[#4A90C4] bg-clip-text text-transparent font-serif">我的个人衣橱</h1>
        </div>
      </header>
    )
  }
      ...
      <header className="h-[60px] flex items-center justify-between px-4 bg-white/90 backdrop-blur-xl relative z-10 shadow-[0_1px_3px_rgba(0,0,0,0.05)]">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="font-semibold text-[var(--brand-heading)] text-lg bg-gradient-to-r from-[#3DA35D] to-[#4A90C4] bg-clip-text text-transparent font-serif tracking-tight">我的个人衣橱</h1>
          </div>
        </div>
