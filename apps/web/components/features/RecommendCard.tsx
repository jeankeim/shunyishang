          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-0.5 relative">
              <button
                ...
                aria-label="喜欢这个推荐"
                className={`min-w-[44px] min-h-[44px] flex items-center justify-center rounded-full transition-all touch-manipulation ${
                  feedback === 'like'
                    ? 'bg-emerald-100 text-emerald-600'
                    : 'hover:bg-stone-100 text-[var(--brand-subtle)] hover:text-emerald-500'
                } disabled:cursor-not-allowed`}
              >
                <svg className="w-5 h-5" fill={feedback === 'like' ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <svg className="w-5 h-5" fill={feedback === 'dislike' ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor">
