          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-1.5 relative">
              <button
                ...
                aria-label="喜欢这个推荐"
                className={`w-9 h-9 md:w-10 md:h-10 flex items-center justify-center rounded-full transition-all touch-manipulation ${
                  feedback === 'like'
                    ? 'bg-emerald-50 text-emerald-600 ring-1 ring-emerald-200'
                    : 'text-stone-400 hover:bg-stone-100 hover:text-emerald-500'
                } disabled:cursor-not-allowed`}
              >
                <svg className="w-[18px] h-[18px] md:w-5 md:h-5" fill={feedback === 'like' ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <svg className="w-[18px] h-[18px] md:w-5 md:h-5" fill={feedback === 'dislike' ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor">
